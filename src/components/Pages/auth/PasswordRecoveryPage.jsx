...
// Импорт стилей
import "./../../../styles/auth/passwordRecoveryPage.css";
    ...
    */
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const responseSendСonfirmationСode = await api.sendCodeAdministratorRecoveryPassword(email);
    ...
    const handleSendConfirmationCode = async () => {
        try {
            ...
            const responseSendConfirmationCode = await api.sendCodeAdministratorRecoveryPassword(email);
    ...
    */
    ...
    return (
        <div className="password-recovery-page-container">
            <h1 className="password-recovery-page-logo">ВкусноРолл.Админ</h1>
