// Поле для выбора нескольких значений из списка (Модифицированная версия с передачей id)
...
const FilterMultiSelectObjectDetail = ({ placeholder, options, selectedValues, onChange }) => {
...
export default FilterMultiSelectObjectDetail;
